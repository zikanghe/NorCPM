...
for ind_r in range(1,2):
    ...
    for i in range(le):
    		...
    		yy_train[i*n_fl:(i+1)*n_fl,0] = aicec[id1[0][i],id1[1][i],0:n_fl]-ficec[id1[0][i],id1[1][i],0:n_fl]
    		yy_train[i*n_fl:(i+1)*n_fl,1] = aicet[id1[0][i],id1[1][i],0:n_fl]-ficet[id1[0][i],id1[1][i],0:n_fl]
